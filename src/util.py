...
def log_validation(
    ...
    **pipe_kwargs
    ...
    for b, valid_example in enumerate(validation_data):
        ...
        validation_image = validation_image.convert("RGBA") # <-- Add this line
        ...
        # Charlie adding image saving
        saved_image_paths = []
        for i, image in enumerate(images):
            # Create a unique filename for each image
            image_filename = f"validation_step_{global_step}_example{b}_image{i}.png"
            image_path = os.path.join(outfile, image_filename)
            print (image_path)
