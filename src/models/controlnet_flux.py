...
# Edit 2
from src.models.transformer import FluxSingleTransformerBlock, FluxTransformerBlock
...
class FluxMultiControlNetModel(ModelMixin):
    ...
    def forward(
        ...
        joint_attention_kwargs: Optional[Dict[str, Any]] = None,
        return_dict: bool = True,
        attention_mask: Optional[torch.Tensor] = None,  # Edit 13  - add attention mask to multi net
        ...
        if len(self.nets) == 1 and self.nets[0].union:
            ...
            for i, (image, mode, scale) in enumerate(zip(controlnet_cond, controlnet_mode, conditioning_scale)):
                block_samples, single_block_samples = controlnet(
                    ...
                    encoder_hidden_states=encoder_hidden_states,
                    attention_mask=attention_mask,  # EDit 13  - add attention mask to multi net
                    txt_ids=txt_ids,
                    img_ids=img_ids,
